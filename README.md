...
font=Fira+Code&pause=900&center=true&vCenter=true&width=650&lines=Full+Stack+Developer+%7C+Computer+Science+Student;Building+Secure+Web+Apps+with+PHP+%26+MySQL;Robotics+Enthusiast+%7C+CoppeliaSim+%7C+Automation;Always+learning%2C+always+improving+🚀" />
</p>
...
- 🔐 Passionate about **web security** (XSS, SQLi, CAPTCHA, hashing, sessions)
- 🧩 Using **Twig** for clean UI and template structure
- 🤖 Robotics enthusiast (CoppeliaSim, line-following robot logic)
- 🚀 Currently learning **JWT, APIs, AJAX, and advanced security**
...
- 🔐 **Secure Login System (PHP + MySQL)**  
  _Hardened authentication with hashing, CAPTCHA, sessions_

- 🎬 **Movie Review Web App**  
  _Firestore CRUD, filtering, rating system_

- 🏫 **University Open Day Website**  
  _Events, gallery, map embed, QR features_

- 🤖 **Robotics Simulation**  
  _Line-following logic using sensor arrays in CoppeliaSim_
